...
public class LogAspect {
	 ...
	 */
	@Pointcut("execution(* com.jianeye.cuckoo3.webside.*.controller.*.add(..))")
	 ...
	 */
	@Pointcut("execution(* com.jianeye.cuckoo3.webside.*.controller.*.update(..)) "
			+ "|| execution(* com.jianeye.cuckoo3.webside.*.controller.*.resetPassword(..)) "
			+ "|| execution(* com.jianeye.cuckoo3.webside.*.controller.*.info(..)) "
			+ "|| execution(* com.jianeye.cuckoo3.webside.*.controller.*.password(..))")
	 ...
	 */
	@Pointcut("execution(* com.jianeye.cuckoo3.webside.*.controller.*.delete*(..))")
	 ...
	 * 删除业务逻辑方法切入点 定义在controller包里以delete为前缀的方法的执行
	 */
	@Pointcut("execution(* com.jianeye.cuckoo3.webside.*.controller.*.permission(..))")
